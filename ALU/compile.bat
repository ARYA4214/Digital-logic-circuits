...
REM
REM Generated by Vivado on Tue Feb 03 22:30:22 +0530 2026
...
echo "xvlog --incr --relax -prj alu_4bit_vlog.prj"
call xvlog  --incr --relax -prj alu_4bit_vlog.prj -log xvlog.log
